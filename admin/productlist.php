         ...
         <div class="col-md-14">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title"> Lista proizvoda</h4>
                ...
                <div class="table-responsive ps">
                  <table class="table tablesorter " id="page1">
                    <thead class=" text-primary">
                      <tr><th>Slika</th><th>Ime</th><th>Cena</th><th>
	<a class=" btn btn-primary" href="addproduct.php">Dodaj novi</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <a class=' btn btn-success' href='clothes_list.php?product_id=$product_id&action=delete'>Obrisi</a>
                        </td></tr>";
                        }

...
?>
      ...
      <div class="content">
		...
		<a>
            ...
            echo "<h1 style='color:#0C0'>Proizvod uspesno dodat! &nbsp;&nbsp;  <span class='glyphicon glyphicon-ok'></h1></span>";
            }
            ?></a>
                </div>
                <div class="col-md-14">
                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Ime</th><th>Prezime</th><th>Email</th><th>Sifra</th><th>Kontakt</th><th>Adresa</th><th>Grad</th>
                    </tr></thead>
                    <tbody>
                      <?php 
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Kategorije</th><th>Broj</th>
                    </tr></thead>
                    <tbody>
                      <?php 
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Brendovi</th><th>Broj</th>
                    </tr></thead>
                    <tbody>
                      <?php 

		...
		<form onsubmit="return false" id="login" class="login100-form ">
			<div class="billing-details jumbotron">
				<div class="section-title">
					<h2 class="login100-form-title p-b-49" >Ulogujte se</h2>
				</div>
				...
				<div class="form-group">
					<label for="email">Sifra:</label>
					<input class="input input-borders" type="password" name="password" placeholder="Sifra" id="password" required>
				</div>
				...
				<input class="primary-btn btn-block"   type="submit"  Value="Uloguj se">
